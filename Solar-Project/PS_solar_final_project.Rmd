...
#adoption graphs with and with out residential skew
...
#town_income <- tibble(town=town,median_income_town=median_income_town)
#town_income
...
Count top 
```{r}
#data visualiziton of per capita income
...
ggplot(solar_resid_grant, aes(x = n, y=mean_grant, color=county))+
 geom_point()+
  ggtitle("Comparison of average grant recieved and number of single family residential solar per county")+
